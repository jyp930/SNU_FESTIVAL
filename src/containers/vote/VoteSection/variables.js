...
export const PHONE_CERT_LIST = [
  ...
  {
    performanceId: 10, name: '슈신자', songs: '괜찮아도 괜찮아 (D.O) 외 9곡', youtubeUrl: 'https://www.youtube.com/embed/86BST8NIpNM?start=70', thumbnail: Poster17Spring,
  },
  {
    performanceId: 11, name: '후렌치파이', songs: '괜찮아도 괜찮아 (D.O) 외 9곡', youtubeUrl: 'https://www.youtube.com/embed/86BST8NIpNM?start=70', thumbnail: Poster17Spring,
  },
];
